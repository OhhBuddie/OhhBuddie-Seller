            ...
            <form action="{{ route('products.store' ) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2" name="brand_id">
                               ...
                               @foreach($brands as $brd)
                                        ...
                                        <option value="{{$brd->brand_name}}">{{$brd->brand_name}}</option>
                ...
                <div class="card Lehenga" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Fit Type</label>
                            <!--<input type="text" class="form-control" name="fit_type">-->
                            <select name="fit_type_6" class="form-control select2" style="height:">
                                <option selected disabled>--Select Fit Type--</option>
                                 @foreach($attr as $fit)
                ...
                <div class="card dresses"  style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <!--        </div>-->
                        <!--        <div class="dropdown-list" id="dropdownContainer{{$subcat_id}}" style="display: none;">-->
                        <!--            <input type="text" class="search-box" id="searchColor{{$subcat_id}}" placeholder="Search color...">-->
                        <!--            <ul id="colorList{{$subcat_id}}">-->
                        <!--                @foreach($colors as $clr)-->
                        <!--                <li data-color="{{ $clr->hex_code }}" data-name="{{ $clr->color_name }}">-->
                ...
                <div class="card Shrugs"  style="display:none;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Fit Type</label>
                            <!--<input type="text" class="form-control" name="fit_type">-->
                            <select name="fit_type_14" class="form-control select2" style="height:">
                                <option selected disabled>--Select Fit Type--</option>
                                 @foreach($attr as $fit)
                ...
                <div class="card Trousers" style="display:none;">
                    ...
                    <div class="row g-3">            
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="waistband_type_1" placeholder="Enter Waistband Type">
                        </div>
                        <!--<div class="col-md-4">-->
                        <!--    <label class="form-label">Fit Type</label>-->
                        <!--    <input type="text" class="form-control" name="fit_type" placeholder="Enter Fit Type">-->
                ...
                <div class="card Leggings" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Waistband Type</label>
                            <input type="text" class="form-control" name="waistband_type_2" placeholder="Enter Waistband Type">
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card Plazos" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Waistband Type</label>
                            <input type="text" class="form-control" name="waistband_type_3" placeholder="Enter Waistband Type">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Length</label>
                ...
                <div class="card Cargos" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Waistband Type</label>
                            <input type="text" class="form-control" name="waistband_type_4" placeholder="Enter Waistband Type">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Length</label>
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Portal  Price</label>
                ...
                <div class="card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">TryOut Eligibility</label>
                            <select class="form-control select2" name="tryout_eligibility">
         ...
         <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    function saveToLocalStorage() {
                        const localImages = allImages.filter(image => image.dataURL); // Only store newly added images
                        localStorage.setItem(`newImages_${productId}`, JSON.stringify(localImages));
                    }
            
                    function loadFromLocalStorage() {
                        const storedImages = JSON.parse(localStorage.getItem(`newImages_${productId}`)) || [];
                        allImages = [...allImages, ...storedImages];
                        updatePreviews();
                    }
            
                    function fetchProductImages() {
                        fetch(`/get-product-images?id=${productId}`)
                            .then(response => response.json())
                            .then(data => {
                                if (data.images) {
                                    allImages = data.images.map(url => ({ url, name: url.split('/').pop() }));
                                    loadFromLocalStorage(); // Load local images after fetching from the database
                                }
                            })
