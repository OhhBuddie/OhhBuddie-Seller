              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <h4 class="mb-0 font-weight-bold d-none d-xl-block">
                     <a href="#" class="dropbtn" style="font-weight: normal; text-decoration: none;">Home</a>
                  </h4>
                </li>
                <li class="nav-item">
                  <h4 class="mb-0 font-weight-bold d-none d-xl-block">
                ...
                <li class="nav-item">
                  <h4 class="mb-0 font-weight-bold d-none d-xl-block">
                     <a href="#" class="dropbtn" style="font-weight: normal; text-decoration: none;">Payments</a>
                  </h4>
                </li>
                ...
                <li class="nav-item">
                  <h4 class="mb-0 font-weight-bold d-none d-xl-block">
                     <a href="#" class="dropbtn" style="font-weight: normal; text-decoration: none;">Reports</a>
                  </h4>
                </li>
